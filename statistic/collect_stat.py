...
class CollectStatistics:
    ...
    def collect_stat_global(self, num_iter, model, train_data_loader, test_data_loader, w_global=None):
        ...
        self.summary_write_train.add_scalar(
            'Accuracy', train_accuracy, num_iter)
        self.summary_write_test.add_scalar(
            'Accuracy', prediction_accuracy, num_iter)
        print("Iter. " + str(num_iter) + "  train accu " +
              str(train_accuracy) + "  test accu " + str(prediction_accuracy))
