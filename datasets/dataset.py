...
def load_data(dataset, data_path, model_name):
    ...
    if dataset == 'MNIST':
        ...
        data_train = SVHN(data_path+'/SVHN', split='train',
                          download=True, transform=transform_train)
        data_test = SVHN(data_path+'/SVHN', split='test',
        ...
        data_train = CelebA(data_path + '/celeba/', transform=transform,
                            train=True, read_all_data_to_mem=False)
        data_test = CelebA(data_path + '/celeba/', transform=transform,
                           train=False, read_all_data_to_mem=False)
